  ...
  return (
    <footer className={styles.footer}>
      ...
      <p className={styles.footerText}>
        A Harrison Communications initiative helping returning residents and
        diaspora professionals reintegrate, build businesses, and thrive in
        Jamaica.
      </p>
...
export function WhatsAppFloat() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with HarriCom on WhatsApp"
    >
